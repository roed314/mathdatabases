...
\begin{itemize}
  ...
  \item website
    ...
    These web pages might either static or dynamically generated.
    For example, when can use 
    There are many ways to do this, here are couple:
    \begin{itemize}
      \item static webpages
        ---
        For example, for each object 
      \item
    This web pages might be static 
    with information on a subjec
  \item web application
    ---
(LMFDB uses Python/Flask/Jinja with javascript/CSS/etc).
  Allows for dynamic generation of pages, links, nicer representation of data

\item HTML front page with downloads (static)
\item Wiki page (dynamic but human generated)
\item web application \end{itemize}
