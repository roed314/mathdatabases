...
Additionally, due to its maturity, PostgreSQL offers a diverse set of open source front ends and administration tools, for example~\cite{pgadmin,adminer}, that lower the learning curve for the SQL language.\todo{R2: MongoDB has numerous open source admin tools as well. Why are the PostgreSQL tools better?}
