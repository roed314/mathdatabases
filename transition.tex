...
% - add one or two sentencs to the introduction briefly explaining 
% why we were motivated to switch (which you explain in more detail 
% later).
% * I love the sound bite "Going forward, the ability to make connections 
% between different kinds of mathematics is one of the core aims of the
% LMFDB, and a relational database will help us achieve this goal."  If 
% there was an easy way to say this earlier (possibly at the end of the 
% intro, see my next commenet) I would do it.
% 
% * I think you could remove the first sentence on page 2 "We also outline 
% our process..." without losing anything, but I might strengthen the last 
% para of the intro by highlighting some realized benefits that you do not 
% mention here but which are much more visible to the user than code 
% refactoring/encapsulation (e.g. performance improvements, consistency 
% checks)
% 
% * I would add a sentence to the end of the paper on page 11 noting the 
% benefits of having automated consistency checks (e.g. "With this 
% framework in place we were able to catch several data errors in recent 
% updates to the new modular forms database that might have otherwise gone 
% unnoticed.").  It kind of just tapers off into nothing as it stands.
% 
% 
% page 9, lines 6-8, I would move the sentence starting "A second 
% optimization was only feasible..." to the end of the para as "This 
% optimization feasiable..."
%
% Wording on the second paragrah of "Using databases in mathematics"


\begin{document}
\title{On Mathematical Databases}
% Maintaining Mathematical Databases
% Managing Mathematical Databases
% Technical aspects of math db
...
We summarize the major differences, including the distinction between a relational database and a document-oriented database, and describe some of the features of each that were important in different stages of the LMFDB's history and that motivated the decision to switch.
...
Moreover, these code changes enabled us to add new features and provided a better foundation for future improvements.
