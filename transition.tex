...
\begin{itemize}
  ...
  \item website
    ...
    LMFDB follows such approach, where all the content is generated on the fly through a dedicated web application based of Flask \cite{flask}, and only a small amount of the content is human-curated.
