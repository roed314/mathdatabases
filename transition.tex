...
\subhead{Website}
    ...
    These pages can be humanly curate each object page \cites{cantorsattic, fanosearch} or, automatically generate them as static web pages \cites{etc, graphclasses, SyzygyData, knotinfo}.
