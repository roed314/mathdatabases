...
\todo{we need to provide high performance indexless queries}
...
For these reasons, WiredTiger was the storage engine behind www.LMFDB.org.
\todo{redo last sentence}
And in this setting PostgreSQL outperforms both, and thus an overall improvement in the performance while keeping the servers of at the same cost.
