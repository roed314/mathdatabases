...
\subhead{Application dependent files}
    ...
    \todoinline{R2: (application dependent). I also disagree with some of the discussion here. Just because it is in an application specific format does not mean that it is not efficiently searchable. It depends entirely on how well the custom data format was implemented. The real issue here seems to be a lack of compatibility and long term maintainability.}
