...
\subhead{Computer algebra system}
    ...
    This option is extremely convenient for the user of those software systems, however, this is not suitable for very large databases, as these would increase the size of the computer algebra system in question.
