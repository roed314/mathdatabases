...
\subhead{On a university/personal server}
    ...
    However, there is both a high initial cost in buying the servers and setting them up. Moreover, one needs to maintain the server for the duration of its life: installing security updates, dealing with service interruptions, and managing backups.
...
Even though we supported such searches through our web interface, many such searches took several minutes to perform within MongoDB, which caused our web front end to timeout.
...
This significantly reduced the search table's size, improved index efficiency, and sped up indexless queries that had to traverse the whole table.
